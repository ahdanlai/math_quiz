...
```
GEMINI should ask:
1. "What is your project name?" → Math Quiz APP
2. "Brief project description?" → A simple math game for primary school students
3. "Project type?"
...
# GEMINI.md - Math Quiz APP

> **Documentation Version**: 1.0  
> **Last Updated**: February 28, 2026  
> **Project**: Math Quiz APP  
> **Description**: A simple math game for primary school students  
...
cat GEMINI_TEMPLATE.md | sed 's/\[PROJECT_NAME\]/Math Quiz APP/g' | sed 's/\[DATE\]/2026-02-28/g' > GEMINI.md
...
8. ✅ **Final message**: 
   ```
   ✅ Project "Math Quiz APP" initialized successfully!
...
A simple math game for primary school students
